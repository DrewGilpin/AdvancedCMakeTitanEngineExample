...
struct ShaderCompiler
{
   ...
   struct Shader
   {
    ...
    C Source          *source;
      ...
      Shader& conservativeDepth(       ) {MAX(model, SM_5  );        return T;} // SM_5   needed for Conservative Depth (DEPTH_GE/DEPTH_LE)
      Shader& conservativeDepth(Bool on) {if(on)conservativeDepth(); return T;} // SM_5   needed for Conservative Depth (DEPTH_GE/DEPTH_LE)
      ...
      Shader& deferred(Int skin, Int materials, Int layout, Int bump_mode, Int alpha_test, Int detail, Int color, Int mtrl_blend, Int uv_scale, Int heightmap, Int fx, Int tesselate)
         {return T("SKIN", skin, "MATERIALS", materials, "LAYOUT", layout, "BUMP_MODE", bump_mode)("ALPHA_TEST", alpha_test)("DETAIL", detail)("COLORS", color, "MTRL_BLEND", mtrl_blend, "UV_SCALE", uv_scale, "HEIGHTMAP", heightmap, "FX", fx).tesselate(tesselate);}

...
Str8 ShaderDeferred   (Int skin, Int materials, Int layout, Int bump_mode, Int alpha_test, Int detail, Int color, Int mtrl_blend, Int uv_scale, Int heightmap, Int fx, Int tesselate);
...
struct DefaultShaders
{
   ...
   void      init(C Material *material[MAX_MTRLS], MESH_FLAG mesh_flag, Int lod_index, Byte heightmap);
   DefaultShaders(C Material *material[MAX_MTRLS], MESH_FLAG mesh_flag, Int lod_index, Byte heightmap) {init(material, mesh_flag, lod_index, heightmap);}
   ...
   void set(Shader *shader[RM_SHADER_NUM], BLST **blst

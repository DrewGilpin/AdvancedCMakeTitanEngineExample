...
// return point casted on the plane along the 'plane_normal' ('plane_normal' doesn't have to be normalized, however it's slower than 'PointOnPlane')
Vec2  PointOnPlaneN(C Vec2  &point,                     C Vec2  &plane_normal); // this function assumes that plane position is Vec2 (0,0)
VecD2 PointOnPlaneN(C VecD2 &point,                     C VecD2 &plane_normal); // this function assumes that plane position is VecD2(0,0)
Vec   PointOnPlaneN(C Vec   &point,                     C Vec   &plane_normal); // this function assumes that plane position is Vec  (0,0,0)
VecD  PointOnPlaneN(C VecD  &point,                     C Vec   &plane_normal); // this function assumes that plane position is Vec  (0,0,0)
VecD  PointOnPlaneN(C VecD  &point,                     C VecD  &plane_normal); // this function assumes that plane position is VecD (0,0,0)
Vec2  PointOnPlaneN(C Vec2  &point, C Vec2  &plane_pos, C Vec2  &plane_normal);
VecD2 PointOnPlaneN(C VecD2 &point, C VecD2 &plane_pos, C VecD2 &plane_normal);
Vec   PointOnPlaneN(C Vec   &point, C Vec   &plane_pos, C Vec   &plane_normal);
VecD  PointOnPlaneN(C Vec   &point, C VecD  &plane_pos, C Vec   &plane_normal);
VecD  PointOnPlaneN(C VecD  &point, C Vec   &plane_pos, C Vec   &plane_normal);
VecD  PointOnPlaneN(C VecD  &point, C VecD  &plane_pos, C Vec   &plane_normal);
VecD  PointOnPlaneN(C VecD  &point, C VecD  &plane_pos, C VecD  &plane_normal);
